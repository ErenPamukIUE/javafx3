...
public class Main extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        tableVBox.getChildren().addAll(tableView, tableHBox);
        ...
        Button dataDiver = new Button("Data Diver");
        dataDiver.getStyleClass().add("button-fazWrench");
        vBox2.getChildren().addAll(label1, label2, label3,dataDiver);
